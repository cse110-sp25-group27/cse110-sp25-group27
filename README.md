...
- [Code Coverage Report](https://cse110-sp25-group27.github.io/cse110-sp25-group27/docs/coverage_report/index.html)
  - Notable achievements: 94.73% of Function Code Coverage

**Daily Standup Stats:**
View the standup report generated by our Discord Bot: [Standup Report](/admin/meetings/standups_report.pdf)

**Check out our 404 Page:**
[404 Error Page](https://cse110-sp25-group27.github.io/cse110-sp25-group27/frontend/pages/doesntexist.html)

**Key Notes About our Process:**
- We switched to discord after Slack free trial ending
  - This allowed us to easily implement Bots, such as the Daily Standup Bot and integrations with github
- We conducted Sprint Reviews on Thursdays after class
- We conducted Retrospectives on Tuesdays after class
- We had a full team meeting on Wednesdays, ranging from 1-3 hours of live work 
...
**Sprint Notes:**
- [Sprint 1 Review](admin/meetings/sprint-review-1.md)
- [Sprint 2 Review](admin/meetings/sprint-review-2.md)
- [Sprint 3 Review](admin/meetings/sprint-review-2.md)

**Retrospective Notes:**
- [Retrospective 1](admin/meetings/retrospective-1.md)
- [Retrospective 2](admin/meetings/retrospective-2.md)
- [Retrospective 3](admin/meetings/retrospective-3.md)
